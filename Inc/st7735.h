...
#include "nrf_gpio.h"
#include "app_error.h" // For error checking
#include <stdbool.h>
...
#define ST7735_SPI_INSTANCE  0 // SPI instance number
extern const nrf_drv_spi_t spi; // SPI instance defined elsewhere

#define ST7735_RES_Pin       NRF_GPIO_PIN_MAP(0, 2)
#define ST7735_CS_Pin        NRF_GPIO_PIN_MAP(0, 3)
#define ST7735_DC_Pin        NRF_GPIO_PIN_MAP(0, 4)
